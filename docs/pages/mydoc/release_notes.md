...
## Changes in 2.0.24
* Change: squeezed out a bit more precision in the clock drift/offset calculation
...
* Fixed: recorder always plays both channels, even when only one channel is selected
